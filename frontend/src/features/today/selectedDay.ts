...
// session/delete/skip writes; past reminder completions are correctable).
// SelectedDayProvider is lifted above the routes (App.tsx) so the viewed day
// survives tabbing between /today and /focus rather than resetting on each
// screen's unmount.
