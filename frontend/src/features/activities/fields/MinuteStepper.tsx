...
export function MinuteStepper({ value, onChange, min = 5, step = 5 }: MinuteStepperProps) {
  return (
    <div className="mt-2.75 flex h-12 items-center gap-3 rounded-xl border border-border bg-surface pr-2 pl-3.75">
      ...
      <div className="flex gap-1">
        ...
        <button type="button" aria-label="Increase" onClick={() => onChange(value + step)} className={stepButtonClassName}>
