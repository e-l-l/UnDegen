    ...
    <Dialog open onOpenChange={(next) => !next && onClose()}>
      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-2 border-b border-[#171717] px-5.5 py-3 lg:hidden">
          <Button type="button" onClick={onClose} aria-label="Close" variant="ghost" size="icon" className="size-8 text-ink-dim">
        ...
        {/* mobile footer */}
        <div className="shrink-0 border-t border-[#171717] px-5.5 py-3 pb-7.5 lg:hidden">
          <Button
            type="button"
            size="lg"
        ...
        {/* desktop footer */}
        <div className="hidden shrink-0 items-center justify-end gap-2.75 border-t border-[#2c2c2c] px-6.5 py-4.5 lg:flex">
          <DialogClose asChild>
